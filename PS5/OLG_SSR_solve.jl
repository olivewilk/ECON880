...
#@elapsed @time model_solve(prim, res; θ = 0.11, z=[3.0,0.5], γ=0.42,eps=0.0001) 
#@elapsed @time Bellman(prim, res) #solve the model!
#@elapsed @time stationary_distribution(prim, res) #solve the model!
#res.F
#sum(res.F)
...
@elapsed @time benchmark= model_solve(prim, res; θ = 0.11, z=[3.0,0.5], γ=0.42,eps=0.01, λ=0.4) 
...
@elapsed @time no_ss= model_solve(prim, res; θ = 0.0, z=[3.0,0.5], γ=0.42,eps=0.01, λ=0.25) 
...
@elapsed @time benchmark_norisk= model_solve(prim, res; θ = 0.11, z=[0.5,0.5], γ=0.42,eps=0.025, λ=0.15) 
...
@elapsed @time norisk_no_ss= model_solve(prim, res; θ = 0.0, z=[0.5,0.5], γ=0.42,eps=0.025, λ=0.15) 
...
@elapsed @time inelastic_l_ss= model_solve(prim, res; θ = 0.11, z=[3.0,0.5], γ=1.0,eps=0.025, λ=0.15) 
...
@elapsed @time inelastic_l_no_ss= model_solve(prim, res; θ = 0.0, z=[3.0,0.5], γ=1.0,eps=0.025, λ=0.15) 
